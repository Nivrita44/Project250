                    ...
                    child: Column(
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            AppLargeText(text: "Sajek",color: Colors.black.withOpacity(0.8)),
                            AppLargeText(text: "12,000 tk", color: AppColors.mainColor),
                          ],
                        ),
                        SizedBox(height: 10,),
                        Row(
                          children: [
                            ...
                            SizedBox(width: 5,),
                            AppText(text: "Rangamati,Chittagong",color: AppColors.textColor1),
                          ],
                        ),
                        SizedBox(height: 20,),
                        Row(
                        ...
                        AppText(text: "You must go for travel.Travelling helps to get rid of hectic life",color: AppColors.mainTextColor),
                      ],
                    ),
